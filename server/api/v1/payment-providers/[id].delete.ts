...
defineRouteMeta({
  openAPI: {
    ...
    description: 'Deletes a payment provider configuration. Only organization owners can delete.',
    ...
    responses: {
      200: { description: 'Payment provider deleted' },
  ...
  if (apiKey) {
    ...
    if (role !== 'organization_owner') {
      throw createError({
        statusCode: 403,
        statusMessage: 'Forbidden',
        message: 'Only organization owners can delete payment providers.',
      })
    }
