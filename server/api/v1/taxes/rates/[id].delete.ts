...
defineRouteMeta({
  openAPI: {
    ...
    description: 'Deletes a tax rate. Only organization owners can delete.',
    ...
    responses: {
      200: { description: 'Tax rate deleted' },
  ...
  if (apiKey) {
    ...
    if (role !== 'organization_owner') {
      throw createError({
        statusCode: 403,
        statusMessage: 'Forbidden',
        message: 'Only organization owners can delete tax rates.',
      })
    }
